...
class PortfolioHandler(object):
    ...
    def _place_orders_onto_queue(self, order_list):
        ...
        any order objects, they are placed on the event queue,
    ...
    def _convert_fill_to_portfolio_update(self, fill_event):
        ...
        be reasonably estimated in a realistic manner, simply by modifying
        how the ExecutionHandler object handles slippage,
    ...
    def update_portfolio_value(self):
        """
        Update the portfolio to reflect the current market value as based
        on last bid/ask of each ticker.
        """
